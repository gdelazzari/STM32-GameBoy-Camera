...
// The value selected during project creation was HSE_VALUE=20000000.
//
...
void
configure_system_clock_internal(void);
...
__initialize_hardware(void)
{
  ...
  configure_system_clock_internal();
}
...
void configure_system_clock_internal(void)
{
	RCC_ClkInitTypeDef RCC_ClkInitStruct;
	RCC_OscInitTypeDef RCC_OscInitStruct;
	...
	RCC_ClkInitStruct.APB1CLKDivider = RCC_HCLK_DIV2;	// APB1 Clock to 42MHz
	...
	HAL_SYSTICK_Config(84000000 / 1000);
